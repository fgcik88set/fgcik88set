...
export default function HeroSection() {
  return (
    <section className="relative w-full h-[90vh] lg:h-screen pt-32 md:pt-20">
      <div className="flex flex-col md:flex-row justify-between items-center w-[95%] gap-6 mx-auto h-full">
