        ...
        <div className="text-center max-w-4xl mx-auto">
          <div className="animate-item">
            ...
            <p className="md:text-xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed">
              Stay connected with your classmates through our exciting lineup of events. From reunions and workshops to
              charity drives and networking sessions, there&#39;s always something happening in our vibrant alumni
              community.
            </p>
          </div>
