        ...
        <div className="w-[95%] mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 max-w-3xl mx-auto">
              Stay updated with upcoming events and relive the memories from our past gatherings and celebrations.
            </p>
          </div>
            ...
            <div className="bg-slate-100 p-1 rounded-lg">
              ...
              >
                <div className="flex items-center gap-2">
                  <div className={`w-2 h-2 rounded-full ${activeTab === 'upcoming' ? 'bg-green-500' : 'bg-green-400'}`}></div>
                  Upcoming Events
                </div>
              </button>
              <button
              ...
              >
                <div className="flex items-center gap-2">
                  <div className={`w-2 h-2 rounded-full ${activeTab === 'past' ? 'bg-amber-500' : 'bg-amber-400'}`}></div>
                  Past Events
                </div>
              </button>
            </div>
          ...
          <div className="mb-8 animate-item">
            <div className="flex items-center justify-between">
              <p className="text-slate-600">
                Showing{" "}
                <span className={`font-semibold ${activeTab === 'upcoming' ? 'text-green-700' : 'text-amber-700'}`}>
              ...
              {!isMobile && (
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {filteredEvents.map((event, index) => {
                    ...
                    const itemsInLastRow = filteredEvents.length % 3;
                    let colSpanClass = '';
                    
                    if (isLastItem && itemsInLastRow > 0 && itemsInLastRow < 3) {
                      // Calculate how many columns the last card should span
                      const remainingCols = 3 - itemsInLastRow;
